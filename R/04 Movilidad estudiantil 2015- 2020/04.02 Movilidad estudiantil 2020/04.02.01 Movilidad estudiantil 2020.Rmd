...
## Gráficos movilidad estudiantil {.tabset .tabset-pills}
...
write.xlsx(tabla, file = paste0(here::here(),"/Output/Estado/03_Movilidad laboral/2020/Indicadores de movilidad estudiantil a nivel estatal 2020.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(),"/Output/Estado/03_Movilidad laboral/2020/Indicadores de movilidad estudiantil a nivel estatal 2020.RData"))
```

```{r, echo = FALSE}
load(file = paste0(here::here(),"/Output/Estado/03_Movilidad laboral/2020/Indicadores de movilidad estudiantil a nivel estatal 2020.RData"))
...
## Gráficos movilidad estudiantil
...
saveRDS(tabla1, file = paste0(here::here(), "/Output/Municipio/04_Movilidad estudiantil/2020/Tablas a nivel municipal_chordDiagram.RDS"))
```
...
saveRDS(tabla2, file = paste0(here::here(), "/Output/Municipio/04_Movilidad estudiantil/2020/Paleta de colores a nivel municipal_chordDiagram.RDS"))
