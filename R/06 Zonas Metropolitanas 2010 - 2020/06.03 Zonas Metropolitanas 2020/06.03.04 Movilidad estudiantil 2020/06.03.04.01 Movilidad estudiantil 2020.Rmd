...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst desagregado por ZM.pdf"), width = 25, height = 25)
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/GSankey de MEst desagregado por ZM_Absolutos.pdf")
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM.pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/ChordDiagram de MEst de ZMVM_a.pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/GSankey de MEst de la ZMVM.pdf")
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Indicadores de Movilidad estudiantil x ZM_Intramunicipal.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Indicadores de Movilidad estudiantil x ZM_Intramunicipal.RData"))
```

```{r, echo = FALSE}
load(file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/04_Movilidad estudiantil/Indicadores de Movilidad estudiantil x ZM_Intramunicipal.RData"))
tabla[1:20,] %>%  
 as.data.frame() %>%
  gt() %>% 
