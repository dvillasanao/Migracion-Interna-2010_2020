...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/GSankey de MTrab desagregado por ZM_Absolutos.pdf")
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/ChordDiagram de MTrab de ZMVM.pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
circos.clear()
pdf(paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/ChordDiagram de MTrab de ZMVM_a.pdf"), width = 18, height = 15)
circos.par(start.degree = 90, 
           gap.degree = 3, 
...
path = paste0(here::here(), "/Graficos/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/GSankey de MTrab de la ZMVM.pdf")
...
write.xlsx(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/Indicadores de movilidad laboral x ZM_Intramunicipal.xlsx"), overwrite = TRUE)

save(tabla, file = paste0(here::here(), "/Output/Municipio/06_Zonas Metropolitanas/2020/03_Movilidad laboral/Indicadores de movilidad laboral x ZM_Intramunicipal.RData"))
```
